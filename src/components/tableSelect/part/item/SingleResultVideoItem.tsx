...
const SingleResultVideoItem: React.FC<ITableSingleResultProps> = (props) => 
{
    const {
        callbackRemove,
        views,
                ...
                <DataContent>
                    {
                        <PlayerBox>                            
                            <Player
                                src={`https://play.wecandeo.com/video/v/?key=${videoKey}`}
...
export default SingleResultVideoItem;